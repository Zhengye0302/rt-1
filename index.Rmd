...
#### Post hoc (Dunn test)
Since the Kruskal-Wallis test is significant, we can use the Dunn test to find the group which has different median. In order to use Dunn test in R, we need to install a package first. Type the following code in the RStudio console, and the package "FSA" will be installed automatically on your computer. 
