...
The example data we are using can be downloaded from [Box](https://missouri.box.com/s/70v91qllsnax3fzwyci2gam30llnu7rh) or [Github](https://raw.githubusercontent.com/zhengyes/rt/master/rExampleData.csv). These data are continous and describe values of 4 types of biomarkers for 144 animals, by treatment by day. There are three categories of treatment type, treatment = 0, 5, 50. The biomarker values are measured on four days, day = 3, 6, 9 and 12. There is only one value for each treatment type and each day.
